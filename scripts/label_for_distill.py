...
규칙:
- 해당 카테고리에 리뷰가 1개 이상 있으면 반드시 summary, bullets, evidence를 채울 것. price도 리뷰가 있으면 bullets와 evidence를 채울 것.
...
- evidence: 해당 카테고리 리뷰 배열 길이 미만의 0-based 인덱스만 사용. 각 bullet당 정확히 하나의 인덱스.
