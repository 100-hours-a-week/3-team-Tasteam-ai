...
```bash
# merged 모델 로컬 경로: ./distill_pipeline_output/merged_models/YYYYMMDD_HHMMSS/
aws s3 sync ./distill_pipeline_output/merged_models/YYYYMMDD_HHMMSS/ s3://n5e655a7w5/merged/ \
